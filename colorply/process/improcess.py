...
def add_cloud_channel(input_ply, calibration_file, orientation_dir, image_dir, image_ext, channel, mode, output_ply, progress = None):
    """
    ...
    newCloud = io.write_plydata(plydata, listNewRadiometry, channel, output_ply)
