...
def test_calib():
    print("\nLoad calibration...")
    calibration_file = "data/calibration/Ori-1bande_All_CampariGCP/AutoCal_Foc-4000_Cam-SequoiaSequoia-REG.xml"
    xmlfile = "data/calibration/Ori-1bande_All_CampariGCP/Orientation-IMG_190716_082134_0016_REG.TIF.xml"
