...
def test_image():
    print("\nMaking an image...")
    orientation_file = "data/calibration/Ori-1bande_All_CampariGCP/Orientation-IMG_190716_082134_0016_REG.TIF.xml"
    image_file = "data/images/REG/IMG_190716_082134_0016_REG.TIF"
...
def test_radiometry_projection():
    ...
    calibration_file = "data/calibration/Ori-1bande_All_CampariGCP/AutoCal_Foc-4000_Cam-SequoiaSequoia-GRE.xml"
    orientation_dir = "data/calibration/Ori-1bande_All_CampariGCP"
    image_dir = "data/images/GRE"
    image_ext = "TIF"
    channel = "GREEN"
